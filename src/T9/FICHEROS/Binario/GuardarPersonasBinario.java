...
//Guardamos un archivo como texto plano:
    
    public static void guardarPersonas(Persona[] personas, String rutaArchivo) {
        try (FileOutputStream fos = new FileOutputStream(rutaArchivo);) {//con esto no hace falta lazar excepcion
